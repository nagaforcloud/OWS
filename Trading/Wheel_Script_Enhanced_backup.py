    ...
    def _save_state(self):
        ...
        try:
            state = {
                ...
                "positions_history": [vars(pos) for pos in self.positions_history],
                "trades_history": [vars(trade) for trade in self.trades_history],
                "timestamp": datetime.datetime.now().isoformat()
            }
    ...
    def _load_state(self):
        ...
        try:
            if os.path.exists(self.state_file):
                ...
                self.logger.info(f"Loaded previous state. Daily P&L: {self.daily_pnl}")
        except Exception as e:
